...
chapters = {
    ...
    5: {
        'start_challenge': 32,
        'end_challenge': 39,
        'title': ('Meet the swordmaster')
    },
    6: {
        'start_challenge': 40,
        'end_challenge': 46,
        'title': ('Fight the kidnapper')
    }
}
...
challenges = {
    ...
    38: {
        'title': ('Go back to the swordmaster\'s.'),
        'chapter': 6
    },
    39: {
        'title': ('Meet the Swordmaster'),
    ...
    40: {
        'title': ('Trail of notes'),
        'chapter': 6
    },
    41: {
        'title': ('Meet the note giver'),
        'chapter': 6
    },
    42: {
